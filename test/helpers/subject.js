...
module.exports = require(process.env.npm_config_coverage	// the trigger is an env variable. See build automation script.
						...
						? '../../coverage/Watai'	// Mocha test coverage generation needs instrumented source, see http://tjholowaychuk.com/post/18175682663
						: '../../src/Watai');	// default to non-instrumented source
