...
GLOBAL.config = config = new ConfigLoader({
	from: __dirname,
	appName: 'watai'
}).load('config');
...
GLOBAL.TestRight = exports.TestRight = require(process.env.npm_config_coverage	// the trigger is an env variable. See build automation script.
