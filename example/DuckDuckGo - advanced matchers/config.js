module.exports = {
	...
	views: [ 'Flow', 'PageDump', 'Growl', 'WebSocket' ],	// you may specify any combination of views you want; see more at <https://github.com/MattiSG/Watai/wiki/Configuration#views>
